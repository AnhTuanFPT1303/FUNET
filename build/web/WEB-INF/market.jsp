        ...
        <div class="row all-post">
            <nav class="col-2 py-3 bg-light sidebar sticky-sidebar position-sticky" style="top: 76px;">
                ...
                <div class="btn-group-vertical w-100 mb-3">
                    ...
                    <a href="/FUNET/notifications" class="btn btn-outline-primary mb-2">Notifications</a>
                    <a href="/FUNET/buying" class="btn btn-outline-primary mb-2">Buying</a>
                    <a href="/FUNET/selling" class="btn btn-outline-primary mb-2">Selling</a>
                </div>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionCategories">
                <div class="accordion-body">
                    <ul class="list-group">
                        <li class="btn btn-outline-secondary mb-2"><a href="#" class="text-decoration-none">Category 1</a></li>
                        <li class="btn btn-outline-secondary mb-2"><a href="#" class="text-decoration-none">Category 2</a></li>
                        <li class="btn btn-outline-secondary mb-2"><a href="#" class="text-decoration-none">Category 3</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <main class="main-class col-10">
                ...
                <h2 class="mt-4 mb-5 text-primary d-flex justify-content-center">Marketplace</h2>
                <div class="row">

                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center;">
                            <h5>Item 1</h5>
                            <img src="assets/product/item.png" alt="Item 1" class="img-fluid" style="max-width: 100%; height: auto;">
                            <p>Price: $10.00</p>
                    ...
                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center;">
                            <h5>Item 2</h5>
                            <img src="assets/product/item.png" alt="Item 2" class="img-fluid" style="max-width: 100%; height: auto;">
                            <p>Price: $15.00</p>
                            <button class="btn btn-primary">Contact to seller</button>
                        </div>
                    </div>
                    ...
                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center;">
                            <h5>Item 3</h5>
                            <img src="assets/product/item.png" alt="Item 3" class="img-fluid" style="max-width: 100%; height: auto;">
                            <p>Price: $20.00</p>
                            <button class="btn btn-primary">Contact to seller</button>
                        </div>
                    </div>
                    ...
                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center;">
                            <h5>Item 4</h5>
                            <img src="assets/product/item.png" alt="Item 4" class="img-fluid" style="max-width: 100%; height: auto;">
                            <p>Price: $25.00</p>
                            <button class="btn btn-primary">Contact to seller</button>
                        </div>
                    </div>
                    ...
                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center;">
                            <h5>Item 5</h5>
                            <img src="assets/product/item.png" alt="Item 5" class="img-fluid" style="max-width: 100%; height: auto;">
                            <p>Price: $30.00</p>
                            <button class="btn btn-primary">Contact to seller</button>
                        </div>
                    </div>
                    ...
                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center;">
                            <h5>Item 6</h5>
                            <img src="assets/product/item.png" alt="Item 6" class="img-fluid" style="max-width: 100%; height: auto;">
                            <p>Price: $35.00</p>
                            <button class="btn btn-primary">Contact to seller</button>
                        </div>
                    </div>
                    <!-- mẫu product trống -->
                    <div class="col-3 mb-3">
                        <div class="product-card border" style="border: 2px solid black; padding: 10px; text-align: center; height: 200px;">
                            <h5 style="color: #ccc;">No Item Available</h5>
                            <div style="border: 1px solid black; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
                                <p style="color: #ccc;">Empty Product</p>
                            </div>
                        </div>
                    </div>
