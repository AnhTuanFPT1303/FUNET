...
CREATE TABLE learningmaterial (
    ...
    learningmaterial_description NVARCHAR(500), -- Increase description length if needed
    ...
    publish_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, -- Add default value
    review NVARCHAR(MAX), -- Change data type as needed
