            ...
            <nav class="navbar custom-navbar">
                <div class="container-fluid d-flex align-items-center">
                    ...
                    <div class="nav-icons d-flex align-items-center">
                        <a href="/FUNET/lmaterialLink" class="fa-solid fa-book fa-lg me-3">
                        </a>
            ...
            <div class="row all-post">
                <nav class="col-2 py-3 bg-light sidebar sticky-sidebar position-sticky" style="top: 76px;">
                    <div class="profile-section mb-3 d-flex align-items-center">
                        <a href="userpageServlet?userId=${sessionScope.user['user_id']}" class="d-flex align-items-center text-decoration-none text-dark"></a>
                    </div>
                    <div class="chat-box mb-3"></div>

                    <form class="d-flex mb-3" method="get" action="/FUNET/searchlearningmaterial">
                        <input class="form-control me-2" name="search-name" type="search" placeholder="Find learning material" aria-label="Search">
                ...
                <main class="main-class col-10">
                    <h2 class="mt-4 mb-5 text-primary d-flex justify-content-center">Learning Material</h2>
                    <div class="row">
