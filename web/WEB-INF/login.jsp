...
<html>
    ...
    <body>
        ...
        <div class="left-section col-md-6">
            ...
            <form class= "input-form" method="post" action="/FUNET/login">
                ...
                <div class="social-login">
                    <p>Or login with</p>
                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost/FUNET/GoogleValidate&response_type=code&client_id=141463377028-7grc9ri1n2peprn9fhuucjamiudeopcs.apps.googleusercontent.com&approval_prompt=force" class="social-login-button">Google</a>
                </div>
            </form>
        </div>
