        ...
        <header id="header">
            <nav class="navbar custom-navbar">
                <div class="container-fluid d-flex align-items-center">
                    <a class="navbar-brand text-primary" href="/FUNET/home" style="font-weight: bold">BLAH</a>
                    ...
                    <a class="navbar-brand text-primary log-out" href="/FUNET" style="font-weight: bold">Log out</a>
                </div>
            </nav>
        </header>
